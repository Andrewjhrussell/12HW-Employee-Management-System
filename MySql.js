...
function start(){
  inquirer.prompt([{
    ...
    if(what.whatToDo === 'View Employees') viewEmp()
    else if(what.whatToDo === 'Add Employee') createEmployee()
    else if(what.whatToDo === 'View Roles') viewRole()
    else process.exit()
  })
}
    ...
    connection.query('SELECT * FROM ROLES',(err, res)=>{
        ...
        inquirer.prompt(
           [
            ...
            connection.query("INSERT INTO employees SET ?",userResponse,
               function (err, res) {
                   if(err) throw err
                   start()
               }
